...
h1,h2,h3,h4{color:var(--text);letter-spacing:.3px}
h2{border-bottom:1px solid var(--border);padding-bottom:8px;margin-top:44px}
h2::before{content:"◆ ";color:var(--cyan);text-shadow:0 0 8px var(--cyan)}
a{color:var(--cyan)}
code{
  background:#131a33;border:1px solid var(--border);border-radius:6px;
  padding:2px 6px;font-size:.9em;color:var(--green);
}
pre{
  background:#0a0e1f;border:1px solid var(--border);border-radius:12px;
  padding:16px;overflow-x:auto;
}
pre code{background:none;border:none;color:var(--text);line-height:1.5}
...
blockquote{border-left:3px solid var(--cyan);background:#0b0f1e;margin:12px 0;padding:8px 16px;color:var(--muted)}
